...
<span className="rounded-full bg-[#F0F8FF] px-4 py-1 text-sm font-medium text-[#0086D1]">{technology.badge}</span>
        ...
        {/* name */}
        <h3 className="mt-3 text-xl text-center  font-semibold text-black">{technology.name}</h3>
        {/* des */}
        <p className=" text-sm  text-justify text-gray-500">{technology.description}</p>
{/* card */}
